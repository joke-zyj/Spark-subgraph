...
public class State {
	...
	public Integer[] core_2; // stores for each pattern graph node to which model graph node it maps ("-1" indicates no mapping)
	...
	public State(Graph modelGraph, Graph patternGraph) {
		...
		core_2 = new Integer[patternSize];
